...
assert not parking.day_compare('IS', parking.today(), "wed"), "Today is not wednesday"
assert parking.day_compare('IS', parking.today(), "sat"), "Today is not saturday"
...
assert not parking.time_compare('BEFORE', parking.now(), 2, 30, 'pm'), "2:30pm < Wednesday"
assert not parking.time_compare('BEFORE', parking.now(), 9, 00, 'am'), "2:30pm < 9:00am"
assert parking.time_compare('BEFORE', parking.now(), 5, 00, 'pm'), "2:30pm < Saturday"

assert parking.time_compare('BEFORE_EQUAL', parking.now(), 2, 30, 'pm'), "2:30pm <= Wednesday"
assert not parking.time_compare('BEFORE_EQUAL', parking.now(), 9, 00, 'am'), "2:30pm <= Monday"
assert     parking.time_compare('BEFORE_EQUAL', parking.now(), 5, 00, 'pm'), "2:30pm <= Saturday"

assert not parking.time_compare('AFTER', parking.now(), 2, 30, 'pm'), "2:30pm > Wednesday"
assert     parking.time_compare('AFTER', parking.now(), 9, 00, 'am'), "2:30pm > Monday"
assert not parking.time_compare('AFTER', parking.now(), 5, 00, 'pm'), "2:30pm > Saturday"

assert     parking.time_compare('AFTER_EQUAL', parking.now(), 2, 30, 'pm'), "2:30pm >= Wednesday"
assert     parking.time_compare('AFTER_EQUAL', parking.now(), 9, 00, 'am'), "2:30pm >= Monday"
assert not parking.time_compare('AFTER_EQUAL', parking.now(), 5, 00, 'pm'), "2:30pm >= Saturday"

assert not parking.time_compare('IS_NOT', parking.now(), 2, 30, 'pm'), "2:30pm != Wednesday"
assert parking.time_compare('IS_NOT', parking.now(), 9, 00, 'am'), "2:30pm != Monday"
assert parking.time_compare('IS_NOT', parking.now(), 5, 00, 'pm'), "2:30pm != Saturday"

assert not parking.time_compare('BEFORE', parking.now(), 12, 00, 'pm'), "2:30pm < Noon"
assert parking.time_compare('AFTER', parking.now(), 12, 00, 'pm'), "2:30pm > Noon"